...
CREATE TABLE `order_requests` (
    ...
    `estimated_delivery_date` DATETIME(0) NULL,
...
CREATE TABLE `products` (
    ...
    `product_category_id` INTEGER UNSIGNED NULL,
...
CREATE TABLE `product_categories` (
    ...
    INDEX `product_categories_order_production_type_id_foreign`(`order_production_type_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `product_material_id` FOREIGN KEY (`product_material_id`) REFERENCES `product_materials`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
